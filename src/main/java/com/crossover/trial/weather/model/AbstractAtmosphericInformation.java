...
public abstract class AbstractAtmosphericInformation
{
	...
	@Nullable
	public abstract DataPoint temperature();

	@Nullable
	public abstract DataPoint wind();

	@Nullable
	public abstract DataPoint humidity();

	@Nullable
	public abstract DataPoint precipitation();

	@Nullable
	public abstract DataPoint pressure();

	@Nullable
	public abstract DataPoint cloudCover();
